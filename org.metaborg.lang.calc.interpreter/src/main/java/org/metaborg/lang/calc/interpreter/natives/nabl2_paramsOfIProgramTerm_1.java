...
@SuppressWarnings("unused") @NodeChild(value = "term", type = TermBuild.class) public abstract class nabl2_paramsOfIProgramTerm_1 extends NaBL2TermBuild 
{ 
  public nabl2_paramsOfIProgramTerm_1 (SourceSection source) 
  { 
    super(source);
  }

  @Specialization public IScopeTerm doGet(IProgramTerm term)
  { 
  ...
  { 
    return nabl2_paramsOfIProgramTerm_1NodeGen.create(source, term);
  }
}