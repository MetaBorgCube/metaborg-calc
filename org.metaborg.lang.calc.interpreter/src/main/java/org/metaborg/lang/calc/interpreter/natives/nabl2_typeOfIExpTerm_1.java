...
@SuppressWarnings("unused") @NodeChild(value = "term", type = TermBuild.class) public abstract class nabl2_typeOfIExpTerm_1 extends NaBL2TermBuild 
{ 
  public nabl2_typeOfIExpTerm_1 (SourceSection source) 
  { 
    super(source);
  }

  @Specialization public ITypeTerm doGet(IExpTerm term)
  { 
    return ITypeTerm.create(getAstProperty(term.getStrategoTerm(), "Type"));
  }

  public static TermBuild create(SourceSection source, TermBuild term)
  { 
    return nabl2_typeOfIExpTerm_1NodeGen.create(source, term);
  }
}